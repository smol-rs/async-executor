...
#[test]
fn local_executor_cancels_everything() {
    static DROP: AtomicUsize = AtomicUsize::new(0);
    static WAKER: Lazy<Mutex<Option<Waker>>> = Lazy::new(Default::default);
...
#[cfg(not(miri))]
#[test]
fn leaked_local_executor_leaks_everything() {
    static DROP: AtomicUsize = AtomicUsize::new(0);
    static WAKER: Lazy<Mutex<Option<Waker>>> = Lazy::new(Default::default);
...
#[test]
fn await_task_after_dropping_local_executor() {
    let s: String = "hello".into();
...
#[test]
fn drop_local_executor_and_then_drop_finished_task() {
    static DROP: AtomicUsize = AtomicUsize::new(0);
...
#[test]
fn drop_finished_task_and_then_drop_local_executor() {
    static DROP: AtomicUsize = AtomicUsize::new(0);
...
#[test]
fn local_iterator_panics_mid_run() {
    let ex = LocalExecutor::new();
